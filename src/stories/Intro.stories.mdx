...
# Conflux Wallet Connect UI for React
...
<div>
  <sub>
    Created by <a href="https://github.com/Charlie85270">Charlie Rabiller</a> 👨‍🍳
  </sub>
</div>

## Features

- 🔥 **Easy to use hook and pre-styled Button and Modal components to connect Metamask, Fluent and OKX wallets to your dApps**
- 🔩 **Easily Customizable, plug your own components**
- ⏳ **Unified API for Metamask, Fluent and OKX wallets, same functions for all providers** - Possibility to trigger functions from specific providers if needed)
...
First, wrap your App with the ConfluxWalletProvider and import the CSS file. It will take care of rendering the connect modal, components, manage the wallets and give you access to all functions to interact with them.
...
And that's it ! You're ready to integrate and use OKX, Metamask and fluent wallet on your dApp ! 🔥
